 ...
 * `data-menu-open` host attribute (`MatExpressiveButton`, `MatExpressiveIconButton`,
 * `MatExpressiveFabMenuTrigger`), replacing a plain `get isMenuOpen()` getter that happened to
