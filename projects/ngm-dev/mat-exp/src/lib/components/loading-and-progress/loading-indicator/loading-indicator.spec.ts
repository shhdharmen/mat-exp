...
import { MatExpLoadingIndicator } from './loading-indicator';
...
describe('MatExpLoadingIndicator', () => {
  ...
  describe('defaults', () => {
    function setup() {
      ...
      stubMatchMedia(true);
      const fixture = TestBed.createComponent(MatExpLoadingIndicator);
    ...
    it('sets the aria-* and data-speed host attributes correctly', () => {
      ...
      expect(host.classList.contains('mat-exp-loading-indicator')).toBe(true);
    });
  });
