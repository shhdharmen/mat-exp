...
export const CONFIGURE_STYLES_MESSAGE =
  "mat-expressive: would you like ng-add to configure Mat Expressive's styles automatically?";
...
function parseComponentsOption(value: string[], context: SchematicContext): ComponentSelection {
  ...
  if (invalid.length > 0) {
    context.logger.warn(
      `mat-expressive: ignoring unknown component key(s) in "components" option: ` +
...
export const COMPONENT_PICKER_MESSAGE =
  'mat-expressive: which components would you like to include styles for?';
